  ...
  const extraCommands: PaletteCommand[] = [
    {
      ...
      category: "Settings",
      icon: Settings,
      run: () => useDialogStore.getState().openDialog("settings"),
    },
    {
      id: "empty-trash",
    ...
    },
    {
      ...
      category: "File",
      icon: Download,
      run: () => useDialogStore.getState().openDialog("exportImport"),
    },
    {
      id: "import-workspace",
    ...
    },
    {
      ...
      category: "Help",
      icon: Info,
      run: () => useDialogStore.getState().openDialog("about"),
    },
    {
    ...
    ...THEME_ORDER.map((id) => ({
      ...
      category: "Theme",
      icon: Palette,
      run: () => useSettingsStore.getState().setTheme(id),
    })),
  ];
