            ...
            >
                ...
                <DialogContent sx={{ pt: '16px !important' }}>
                    ...
                    {[
                        ...
                        { icon: '📁', title: 'File Management', desc: 'Create, rename & delete files • Open from computer • Multi-tab editing with drag reorder • Sidebar with search • Right-click menus • Auto-save to browser • Persistent storage' },
                        ...
                        { icon: '☁️', title: 'Cloud Sync', desc: 'Google Sign-In • Sync to Google Drive • Backup & restore • Access files anywhere' },
                        { icon: '🎨', title: 'Customization', desc: 'Dark & Light themes • UTF-8, ANSI, UCS-2 encodings • Line ending options • Language selection • Toggle sidebar • Font size control' },
                    ].map((section) => (
