...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 fixed inset-0 z-50 bg-slate-950/40 duration-200 supports-backdrop-filter:backdrop-blur-[3px]",
        className,
      )}
      {...props}
    />
